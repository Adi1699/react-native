...
const task1 = () => {
    const [state, AnimationState] = React.useState({
      ...
      let iniSecArray = [
        {
          SectionName: "Android Development",
          lectures: ["Fragments", "Navigation","Intents","Event Handling"],
        },
        {
          SectionName: "Python",
          lectures: ["Operators","Inheritance"],
        },
      ];
              ...
              <View key={index} style={styles.sectionContainer}>
                <View style={styles.section}>
                  ...
                  <TouchableOpacity onPress={() => handleOpen(section)}>
                    <Icon name="add-outline" color="blue" size={25} />
                  </TouchableOpacity>
                </View>
                <View>
    ...
    const styles = StyleSheet.create({
      ...
      buttonStyles: { backgroundColor: "blue", borderRadius: 5, padding: 10 },
